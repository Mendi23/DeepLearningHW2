...
def run_experiment(run_name, out_dir='./results', seed=None,
                   ...
                   hidden_dims=[1024], ycn=False, print_every=5, **kw):
    """
    ...
    dl_test = torch.utils.data.DataLoader(ds_test, int(bs_train/4), shuffle=False)
    ...
    fit_res = trainer.fit(dl_train, dl_test, epochs, max_batches=batches, print_every=print_every, early_stopping=early_stopping)    
    # ========================
